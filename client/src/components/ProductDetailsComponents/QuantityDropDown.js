...
class QuantityDropDown extends React.Component {
  ...
  render() {
    return (
      <select id="quantity-drop-down" className="medium add-to-cart-input" name="quantity" value={this.props.quantity} onChange={this.props.handleChange} style={this.props.quantityError ? { borderColor: 'red' } : { borderColor: 'black' }}>
